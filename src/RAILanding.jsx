        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><a href="#" className="hover:text-white">{t.footerLegal[0]}</a></li>
                <li><a href="#" className="hover:text-white">{t.footerLegal[1]}</a></li>
                <li><a href="#" className="hover:text-white">{t.footerLegal[2]}</a></li>
              </ul>
            </div>
            <div>
